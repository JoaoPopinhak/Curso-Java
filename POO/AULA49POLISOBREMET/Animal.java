...
public class Animal {
	...
	public void barulho(){//metodo generico do pai
		System.out.println("Barulho");
	}
	
	public Animal(){//Criando o construtor do pai
		
	}
	
	public Animal(double peso, String comida){//Criando o construtor do pai
		this.comida = comida;
		this.peso = peso;
	}
